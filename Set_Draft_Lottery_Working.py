...
print (team1[0]+ " has the following balls: " + str(team_1))
time.sleep(1)
print (team2[0]+ " has the following balls: " + str(team_2))
time.sleep(1)
print (team3[0]+ " has the following balls: " + str(team_3))
time.sleep(1)
print (team4[0]+ " has the following balls: " + str(team_4))
time.sleep(1)
print (team5[0]+ " has the following balls: " + str(team_5))
time.sleep(1)
print (team6[0]+ " has the following balls: " + str(team_6))
time.sleep(1)
print (team7[0]+ " has the following balls: " + str(team_7))
time.sleep(1)
print (team8[0]+ " has the following balls: " + str(team_8))
time.sleep(1)
print (team9[0]+ " has the following balls: " + str(team_9))
time.sleep(1)
print (team10[0]+ " has the following balls: " + str(team_10))
time.sleep(1)
print (team11[0]+ " has the following balls: " + str(team_11))
time.sleep(1)
print (team12[0]+ " has the following balls: " + str(team_12))
print()
